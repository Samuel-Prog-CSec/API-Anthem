...
Esquemas Mongoose y métodos estáticos que concentran la lógica de negocio y agregaciones. Incluyen índices, validaciones y `maxTimeMS` para consultas seguras y eficientes.
...
- `ScooterAssignment.js`: asignación y seguimiento de patinetes.
- `TokenBlacklist.js`: tokens revocados para invalidar sesiones.
- `Traffic.js`: intensidad, velocidad y ocupación de la red viaria.
- `User.js`: credenciales, roles y control de autenticación.
